...
fs_vect          = 5:5:100;              % Use this vector to extract different values of fs in your code
BER_case_2_vec  = zeros(size(fs_vect));  % Use this vector to store the resultant BER
...
for fs_ind = 1:length(fs_vect)
    ...
    BER_case_2_vec(fs_ind) = ComputeBER(bit_seq,rec_bit_seq);
end

figure
plot(fs_vect,BER_case_2_vec,'o-r','linewidth',2); hold on;
